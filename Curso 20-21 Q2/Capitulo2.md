...
Ten en cuenta que no tenemos que observarlos en un experimento en particular: estamos usando lógica y no observación.
...
Piensa en Laplace y frene todos los eventos posibles de E en partes iguales.
...
Piensa en Venn y está claro que si P es una frecuencia en el caso límite, entonces, como las frecuencias se pueden agregar, las probabilidades también.
