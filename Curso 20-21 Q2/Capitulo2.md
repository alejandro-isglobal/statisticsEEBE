...
$\bar{x}=\frac{1}{20}\sum_{obs=1,..20} x_{obs}=\sum_{i=1,..6}x_{i}*f_i$
...
$s^2=\frac{1}{N-1} \sum_{obs=1,..20} (x_{obs}-\bar{x})^2=\frac{N}{N-1} \sum_{i=1,..6} (x_i-\bar{x})^2 f_i=1.70$
...
Piense en Venn y está claro que si P es una frecuencia en el caso límite, entonces, como las frecuencias se pueden agregar, las probabilidades también.
...
- ¿Cuál es la expresión matemática de la probabilidad de encontrar **todos** los semáforos en rojo?

- ¿Cuál es la expresión matemática la probabilidad de encontrar **algún**  semáforo en rojo? Intenta usar un diagrama de Venn para escribir esta probabilidad en términos de probabilidades de intersecciones, también llamadas probabilidades conjuntas.  
...
Imaginemos un experimento aleatorio que mida dos tipos diferentes de resultados, experimento de tipo $A$ y experimento de tipo $B$
...
En muchos casos, nos interesa saber si el resulatdo de un experimento **condiciona** el resultado de otro.


Probabilidad conjunta
==================================================

- si observamos que un individuo alto es probable que sea pesado.

- el tiempo que tarda una carga en golpear un detector en un lugar en particular podría decirnos si pasó a través de un campo eléctrico.

- si observamos un número en un dado, no nos dirá cuál es el número del otro dado.
...
Probamos una batería para saber cuánto tiempo puede durar Cargamos en un cable para saber si se resiste una determinada carga. Realizamos una PCR para ver si alguien está infectado.
